...
### 3.2 SAT Definition and Cook-Levin Reduction
...
### 3.3 3-SAT Problem and Traditional Solution Difficulties
...
### 3.4 DNA Computing Model and Its Application Capabilities in SAT Problems
...
<div style="text-align: center;">
  <a href="https://imgchr.com/i/pZmyU9P">
    <img src="https://s41.ax1x.com/2025/12/06/pZmyU9P.png" alt="pZmyU9P.png" style="width: 55%; height: 55%; margin: auto;" />
  </a>
  <div style="color: #000; font-size: 0.9em; font-style: italic; margin-top: 8px;">
...
<h2 style="text-align: center;">5 Open Source Simulation Code for DNA Computation and Visualization</h2>
...
<div align="center">
  <a href="https://imgchr.com/i/pZ13LCT">
    <img src="https://s41.ax1x.com/2025/12/18/pZ13LCT.png" alt="pZm69UA.png" style="width: 85%;" />
  </a>
...
### 5.1 Python Simulation Framework[^3]
  
This Python simulation framework is designed to simulate key biochemical operations in DNA computing. It employs an object-oriented design and includes operations such as DNA strand initialization, amplification, separation, and screening. The simulation process is as follows:
...
#### 5.3.1 Complementary Sequences and Reverse Complementary Sequences
...
#### 5.3.2 PCR Amplification Simulation
...
#### 5.3.3 Separation and Screening Operations
...
Since 2002, DNA computing has continued to develop in the field of SAT and more broadly in constraint satisfaction problems, with main directions including:

1. Automation and Microfluidics: DNA logic gate circuits → Fully automated 20-variable SAT solvers

2. Molecular Programming Languages and Compilers: CRN-to-DNA compilers

3. Integration with Other Emerging Computing Paradigms: Such as DNA+genetic algorithms, graph neural networks (GNN)

4. Scaling Attempts: Using DNA origami to solve a 70-variable random 3-SAT instance *(Yigong Shi, 2021)*
